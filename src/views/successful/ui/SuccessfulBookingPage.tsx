  ...
  return (
    <>
      <div className="flex flex-col items-center gap-10 rounded-[4px] border border-white/10 bg-element/5 p-6">
        <Check size={100} />
        <h1 className="text-center font-bicubik text-md lg:text-2xl">
          Успешное бронирование
        </h1>
        <div className="flex flex-col items-center gap-5">
          <h3 className="text-center font-bicubik text-sm lg:text-lg">
        ...
        <h4 className="text-sm lg:text-md">Контакты - 8 (800) 5555-3535</h4>
        <Button
          variant="purple"
          size="none"
